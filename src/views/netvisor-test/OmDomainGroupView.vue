<template>
  <div class="om-split-page">
    <div class="om-split-left">
      <div class="om-split-head">域名群组</div>
      <div class="ou-toolbar">
        <input class="ou-toolbar-input" type="search" placeholder="关键字查询" disabled />
    ...
    <div class="om-split-right">
      <div class="om-split-head">群组域名展示</div>
      <div class="ou-toolbar">
        <label class="tdh-filter-field">
          <span class="ou-toolbar-label">群组域名</span>
          <select class="ou-toolbar-select" disabled>
            <option selected>为空表示全局搜索</option>
          </select>
        </label>
