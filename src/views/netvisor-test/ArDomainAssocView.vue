<template>
  <div class="nvt-page">
    ...
    <div class="ou-table-wrap ar-table-wrap">
      <table class="ou-table ar-da-table">
        <thead>
          <tr>
...
const tableData = ref([
  { domain: 'www.example.com', port1: '80', port2: '443', trackDns: '是', trackHost: '是', protocol: 'HTTP' },
  { domain: 'api.example.com', port1: '443', port2: '', trackDns: '是', trackHost: '否', protocol: 'HTTPS' },
  { domain: 'cdn.example.com', port1: '80', port2: '443', trackDns: '否', trackHost: '是', protocol: 'HTTP' },
  { domain: 'dns.google.com', port1: '53', port2: '853', trackDns: '是', trackHost: '否', protocol: 'DNS' },
  { domain: 'update.microsoft.com', port1: '443', port2: '', trackDns: '是', trackHost: '是', protocol: 'HTTPS' }
])
</script>
